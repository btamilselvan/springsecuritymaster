...
/**
 * Store the oauth request and redirect_uri in the cookie because there is no session management
 * policy is stateless
 *
 * @author Tamil
 */
@Component
@Primary
public class MyCustomOAuthRequestRepoisotry
  ...
  public OAuth2AuthorizationRequest loadAuthorizationRequest(HttpServletRequest request) {
    OAuth2AuthorizationRequest cachedRequest =
